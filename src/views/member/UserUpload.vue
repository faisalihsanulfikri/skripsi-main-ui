  ...
  <div>
    <div class="uk-grid" uk-grid>
      <div class="uk-width-expand">
        ...
        <form>
          <div class="uk-margin">
            <label class="uk-form-label">Tipe Dokumen</label>
            <div>
              <label>
                <input v-model="user.gender" id="profile-gender-male" class="uk-radion" type="radio" value="npwp"/> NPWP
              </label>
              <label class="uk-margin-small-left">
                <input v-model="user.gender" id="profile-gender-female" class="uk-radion" type="radio" value="ktp"/> KTP
              </label>
              <label class="uk-margin-small-left">
                <input v-model="user.gender" id="profile-gender-female" class="uk-radion" type="radio" value="dokobat"/> Dokumen Obat / Makanan
              </label>
            </div>
          </div>
